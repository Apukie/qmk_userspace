...
// │                                                                                                 │
// │  ───  RTOG  RMOD RRMOD  SPI  SPD  ║  ───   ───   ───   ───   ───   ───                         │
// │  ───   ───  HUI   SAI   VAI  ───  ║  ───   ───  BOOT  RESET EECLR  ───                         │
// │  ───   ───  HUD   SAD   VAD  ───  ║  ───   ───   ───   ───   ───   ───                         │
// │                   [SYS combo]      ║             [SYS combo]                                   │
// └─────────────────────────────────────────────────────────────────────────────────────────────────┘
  [SYS] = LAYOUT_corne_hlc(
    _______, RGB_TOG, RGB_MOD, RGB_RMOD,RGB_SPI, RGB_SPD,      _______, _______, _______, _______, _______, _______,
    _______, _______, RGB_HUI, RGB_SAI, RGB_VAI, _______,      _______, _______, QK_BOOT, QK_RBT,  EE_CLR,  _______,
