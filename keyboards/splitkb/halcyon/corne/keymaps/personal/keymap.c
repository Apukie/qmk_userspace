...
// │                                                                                                 │
// │  ───   ───  TOGG  PREV  NEXT  ───  ║  ───   ───   ───   ───   ───   BOOT                        │
// │  ───  SPDU  HUEU  SATU  VALU ───  ║  ───   ───   ───   ───   ───   RBT                         │
// │  ───  SPDD  HUED  SATD  VALD ───  ║  ───   ───   ───   ───   ───  EECLR                        │
// │                   [SYS combo]      ║             [SYS combo]                                   │
// └─────────────────────────────────────────────────────────────────────────────────────────────────┘
  [SYS] = LAYOUT_corne_hlc(
    _______, _______, RM_TOGG, RM_PREV, RM_NEXT, _______,      _______, _______, _______, _______, _______, QK_BOOT,
    _______, RM_SPDU, RM_HUEU, RM_SATU, RM_VALU, _______,      _______, _______, _______, _______, _______, QK_RBT,
    _______, RM_SPDD, RM_HUED, RM_SATD, RM_VALD, _______,      _______, _______, _______, _______, _______, EE_CLR,
                               _______, _______, _______,      _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
};
