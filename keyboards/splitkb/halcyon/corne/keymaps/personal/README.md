# Personal — Halcyon Corne rev2 keymap
...
Left hand: window mgmt on top row cols 2–4 (`Alt+F4`, `Shift+Tab`, `Alt+Tab`), one-shot mods on home row, `Undo`/`Redo` on bottom row cols 3–4.
